...
class HashableMixin(object):
    ...
    keys and values of the dictionary. The hash value is case-insensitive
    (i.e. it does not change for different lexical cases of a key) and
    order-insensitive (i.e. it does not change for a different order of items).
