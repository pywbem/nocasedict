...
built-in `dict class of Python 3.14`_ on all Python versions it supports
(except for being case-insensitive, of course).

.. _dict class of Python 3.14: https://docs.python.org/3.14/library/stdtypes.html#dict
