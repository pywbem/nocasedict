...
* Removed support for Python 3.8, because (1) Python 3.8 is out of service since
  ...
  not support environment markers. (`#259 <https://github.com/pywbem/nocasedict/issues/259>`_)
...
* License: Increased the license from LGPL 2 or later to LGPL 2.1 or later for
  ...
  when nocasedict was separated out from pywbem. (`#235 <https://github.com/pywbem/nocasedict/issues/235>`_)

**Enhancements:**

* Added support for Python 3.14.

* Added support for union operators `d1 | d2` and `d1 |= d2`. (`#194 <https://github.com/pywbem/nocasedict/issues/194>`_)
...
* Used new license format defined in PEP 639 to accommodate upcoming removal
  of support for old format. (`#235 <https://github.com/pywbem/nocasedict/issues/235>`_)
